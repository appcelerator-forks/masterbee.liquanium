...
function Controller() {
    ...
    _.extend($, $.__views);
    var args = arguments[0] || {}, templates = args.children, IS_IOS = true, activityType = IS_IOS ? Ti.UI.iPhone.ActivityIndicatorStyle.DARK : Ti.UI.ActivityIndicatorStyle.DARK;
    (function(args, $) {
        delete args.id;
